	            ...
	            if (isset($_POST['next2']))
					{
						...
						echo "<p>
								<table>
					               <tr>
					                   <td height='60' colspan='2'>By continuing you agree to the non-disclosure policy, under penalty of prosecution.                                          Furthermore, you acknowledge the existence of a higher being who is none other than me.</td>
					               </tr>
					               <tr>

					                   <td height='50' colspan='2'>I have read and accept the conditons <input type='checkbox'/></td>
					               </tr>
					               <tr>
