...
<head>
	...
	<meta charset="utf-8">
	<title>PHP Assessment Exercise 1-5</title>
...
<body>
	...
	<form method="post" id="formulaire" name="form">
		<fieldset>
			...
			<p><input type="text" name="title" value="<?php echo $title;?>"></input>  <input type="text" name="name" value="<?php echo $name;?>"></input>  <input type="text" name="email" value="<?php echo $email;?>"></input> <input type="text" name="adr0" value="<?php echo $address[0];?>"></input>
			<input type="text" name="adr1" value="<?php echo $address[1];?>"></input>  <input type="text" name="adr2" value="<?php echo $address[2];?>"></input>  <input type="text" name="postcode" value="<?php echo $postcode;?>"></input>  <input type="text" name="tel" value="<?php echo $telephone;?>"></input></p>
